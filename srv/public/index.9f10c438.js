class e extends HTMLElement{_root=null;_init=!1;_timer=null;_score=null;constructor(){super(),this._root=this.attachShadow({mode:"open"})}connectedCallback(){this._init||(this.shadowRoot.innerHTML=function(){let e=`
    ...
    `;return`${e}${s}${i}`}(),this.setAttribute("class","progress"),this._timer=this.shadowRoot.querySelector(".progress-time span"),this._score=this.shadowRoot.querySelector(".progress-score span"),this._init=!0)}attributeChangedCallback(e,s,i){}set score(e){this._score.innerHTML=`${e}`.padStart(4,"0")}set timer(e){this._timer.innerHTML=`${e}`.padStart(4,"0")}set show(e){e?this.style.visibility="visible":this.style.visibility="hidden"}}customElements.define("nice2jm-progressboard",e);